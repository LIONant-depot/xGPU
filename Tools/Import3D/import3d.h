...
namespace import3d
{
    ...
    public:
        ...
        bool Import( std::string FileName, import3d::geom* pGeom, import3d::skeleton* pSkeleton, import3d::anim_package* pAnimPackage ) noexcept
        {
            xcore::function::scope CleanUp([&]
            {
                //
