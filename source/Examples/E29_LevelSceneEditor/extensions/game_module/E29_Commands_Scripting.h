...
namespace e29::commands
{
    ...
    //================================================================================================
    struct add_script_source_file_cmd : editor_command
    {
        add_script_source_file_cmd(xundo::system& System, void* pDataBase) noexcept : editor_command(System, "AddScriptSourceFile", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct remove_script_source_file_cmd : editor_command
    {
        remove_script_source_file_cmd(xundo::system& System, void* pDataBase) noexcept : editor_command(System, "RemoveScriptSourceFile", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct list_script_source_files_query_cmd : editor_query_command
    {
        list_script_source_files_query_cmd(xundo::system& System, void* pDataBase) noexcept : editor_query_command(System, "ListScriptSourceFiles", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct set_script_source_file_content_cmd : editor_command
    {
        set_script_source_file_content_cmd(xundo::system& System, void* pDataBase) noexcept : editor_command(System, "SetScriptSourceFileContent", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct rename_script_source_file_cmd : editor_command
    {
        rename_script_source_file_cmd(xundo::system& System, void* pDataBase) noexcept : editor_command(System, "RenameScriptSourceFile", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct add_project_module_reference_cmd : editor_command
    {
        add_project_module_reference_cmd(xundo::system& System, void* pDataBase) noexcept : editor_command(System, "AddProjectModuleReference", pDataBase) { RegisterArguments(); }
    ...
    struct remove_project_module_reference_cmd : editor_command
    {
        remove_project_module_reference_cmd(xundo::system& System, void* pDataBase) noexcept : editor_command(System, "RemoveProjectModuleReference", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct list_project_module_references_query_cmd : editor_query_command
    {
        list_project_module_references_query_cmd(xundo::system& System, void* pDataBase) noexcept : editor_query_command(System, "ListProjectModuleReferences", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct regenerate_project_module_sources_query_cmd : editor_query_command
    {
        regenerate_project_module_sources_query_cmd(xundo::system& System, void* pDataBase) noexcept : editor_query_command(System, "RegenerateProjectModuleSources", pDataBase) { RegisterArguments(); }
