...
namespace e29::commands
{
    ...
    //================================================================================================
    struct add_library_dependency_cmd : editor_command
    {
        add_library_dependency_cmd(xundo::system& System, void* pDataBase) noexcept : editor_command(System, "AddLibraryDependency", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct remove_library_dependency_cmd : editor_command
    {
        remove_library_dependency_cmd(xundo::system& System, void* pDataBase) noexcept : editor_command(System, "RemoveLibraryDependency", pDataBase) { RegisterArguments(); }
        const char* getCommandHelp() const noexcept override
        {
    ...
    //================================================================================================
    struct create_library_query_cmd : editor_query_command
    {
        create_library_query_cmd(xundo::system& System, void* pDataBase) noexcept : editor_query_command(System, "CreateLibrary", pDataBase) { RegisterArguments(); }
        const char* getCommandHelp() const noexcept override
        {
    ...
    //================================================================================================
    struct list_legal_reference_libraries_query_cmd : editor_query_command
    {
        list_legal_reference_libraries_query_cmd(xundo::system& System, void* pDataBase) noexcept : editor_query_command(System, "ListLegalReferenceLibraries", pDataBase) { RegisterArguments(); }
        const char* getCommandHelp() const noexcept override
        {
