...
Play is what triggers it. The recompile-check finds the module stale, rebuilds it (tens of seconds), swaps the DLL and
...
GAME_SOURCE = REPO / "source" / "Examples" / "E29_LevelSceneEditor" / "GameProject" / "E29_Game.cpp"
