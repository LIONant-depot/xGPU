...
int E02_Example()
{
    ...
    for (int i = 0; i < PipeLineInstance.size(); ++i)
    {
        xgpu::texture Texture;
        {
            ...
            auto                    MipSizes = std::array{ xgpu::texture::setup::mip_size{ size_v * size_v * sizeof(std::uint32_t) } };

            Setup.m_Height      = size_v;
            Setup.m_Width       = size_v;
            Setup.m_MipSizes    = MipSizes;
            ...
            Setup.m_AllFacesData = std::span{ reinterpret_cast<const std::byte*>(TextureData->data()), MipSizes[0].m_SizeInBytes };
        ...
        (void)VertexBuffer.MemoryMap(0, 24, [&](void* pData)
            {
                ...
                pVertex[0]  = { -0.5f, -0.5f,  0.5f, 0.0f, 1.0f,0xffff0000u };
                pVertex[1]  = {  0.5f, -0.5f,  0.5f, 1.0f, 1.0f,0xffff0000u };
                pVertex[2]  = {  0.5f,  0.5f,  0.5f, 1.0f, 0.0f,0xffff0000u };
                pVertex[3]  = { -0.5f,  0.5f,  0.5f, 0.0f, 0.0f,0xffff0000u };

                // Back face
                pVertex[4]  = { -0.5f, -0.5f, -0.5f, 0.0f, 1.0f, 0xff660000u };
                pVertex[5]  = { -0.5f,  0.5f, -0.5f, 1.0f, 1.0f, 0xff660000u };
                pVertex[6]  = {  0.5f,  0.5f, -0.5f, 1.0f, 0.0f, 0xff660000u };
                pVertex[7]  = {  0.5f, -0.5f, -0.5f, 0.0f, 0.0f, 0xff660000u };

                // Top face
                pVertex[8]  = { -0.5f,  0.5f, -0.5f, 0.0f, 1.0f, 0xff00ff00u };
                pVertex[9]  = { -0.5f,  0.5f,  0.5f, 1.0f, 1.0f, 0xff00ff00u };
                pVertex[10] = {  0.5f,  0.5f,  0.5f, 1.0f, 0.0f, 0xff00ff00u };
                pVertex[11] = {  0.5f,  0.5f, -0.5f, 0.0f, 0.0f, 0xff00ff00u };

                // Bottom face
                pVertex[12] = { -0.5f, -0.5f, -0.5f, 0.0f, 1.0f, 0xff006600u };
                pVertex[13] = {  0.5f, -0.5f, -0.5f, 1.0f, 1.0f, 0xff006600u };
                pVertex[14] = {  0.5f, -0.5f,  0.5f, 1.0f, 0.0f, 0xff006600u };
                pVertex[15] = { -0.5f, -0.5f,  0.5f, 0.0f, 0.0f, 0xff006600u };

                // Right face
                pVertex[16] = { 0.5f, -0.5f, -0.5f, 0.0f, 1.0f, 0xff0000ffu };
                pVertex[17] = { 0.5f,  0.5f, -0.5f, 1.0f, 1.0f, 0xff0000ffu };
                pVertex[18] = { 0.5f,  0.5f,  0.5f, 1.0f, 0.0f, 0xff0000ffu };
                pVertex[19] = { 0.5f, -0.5f,  0.5f, 0.0f, 0.0f, 0xff0000ffu };

                // Left face
                pVertex[20] = { -0.5f, -0.5f, -0.5f, 0.0f, 1.0f, 0xff000066u };
                pVertex[21] = { -0.5f, -0.5f,  0.5f, 1.0f, 1.0f, 0xff000066u };
                pVertex[22] = { -0.5f,  0.5f,  0.5f, 1.0f, 0.0f, 0xff000066u };
                pVertex[23] = { -0.5f,  0.5f, -0.5f, 0.0f, 0.0f, 0xff000066u };
            });
    }
        ...
        for (auto& W : lWindow)
        {
            ...
            // Get the command buffer ready to render
            {
                ...
                // Render first object (animated mesh)
                {
                    ...
                    xmath::fmat4 L2W;
                    L2W.setupSRT({1}, {0_xdeg,R,0_xdeg}, {0});
                ...
                {
                    xmath::fmat4 L2W;
                    L2W = xmath::fmat4::fromTranslation({ 0,-0.5f, -1.1f });
