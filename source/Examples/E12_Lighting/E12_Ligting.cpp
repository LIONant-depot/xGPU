...
int E12_Example()
{
    ...
    xgpu::pipeline_instance PipeLineInstance;
    {
        ...
        //
        {
            ...
            // Load file
            //
            if (auto Err = xbmp::tools::loader::LoadDSS(Bitmap, L"../../Assets/StoneWal01_1K/Stone Wall 01_1K_Normal - Compress BC5.dds" ); Err) // "../../Assets/normal_maps-test-BC5.dds");Err ) // 
            {
                e12::DebugMessage( Err.getMessage());
