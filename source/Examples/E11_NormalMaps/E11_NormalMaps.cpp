...
int E11_Example()
{
    ...
    xgpu::pipeline_instance PipeLineInstance;
    {
        ...
        //
        {
            ...
            // Load file
            //
            if (auto Err = xbmp::tools::loader::LoadDSS(Bitmap, //L"../../Assets/normal_maps-test-fullcolor.dds"
                                                                 L"../../Assets/normal_maps-test-BC5.dds" 
                                                                // L"../../Assets/normal_mapping_normal_map.dds"
                                                                //    L"../../Assets/normal_map_raisen.dds"
                                                                // L"../../Assets/StoneWal01_1K/Stone Wall 01_1K_Normal - Compress BC5.dds"
                                                                // L"../../Assets/StoneWal01_1K/Stone Wall 01_1K_Normal - Compress DXT5.dds"
            ); Err)
            {
                e11::DebugMessage(Err.getMessage().data());
    ...
    {
        std::array<xmath::fvec3,3> pos;
        std::array<xmath::fvec2,3> uv;
        ...
        const xmath::fvec3 Tangent = xmath::fvec3
        ...
        const xmath::fvec3 Binormal = xmath::fvec3
        ...
        for (int i = 0; i < 3; ++i)
        {
            ...
            const xmath::fvec3 ONormal { Vert.m_Normal.m_X,   Vert.m_Normal.m_Y, Vert.m_Normal.m_Z  };
            const xmath::fvec3 OTangent{ Vert.m_Tangent.m_X, Vert.m_Tangent.m_Y, Vert.m_Tangent.m_Z };
            const xmath::fvec3 OBinormal = (xmath::fvec3{ OTangent }.Cross(xmath::fvec3{ ONormal })).NormalizeSafe();
        }
    }
        ...
        (void)VertexBuffer.MemoryMap(0, static_cast<int>(Mesh.m_Vertices.size()), [&](void* pData)
            {
                ...
                for( int i=0; i< static_cast<int>(Mesh.m_Vertices.size()); ++i )
                {
                    ...
                    V.m_Binormal = (xmath::fvec3{ V.m_Tangent }.Cross(xmath::fvec3{ V.m_Normal } )).NormalizeSafe();
