...
namespace e14
{
    ...
    struct push_constants
    {
        ...
        xmath::fvec3 m_LocalSpaceEyePos;
...
int E14_Example()
{
    ...
    xgpu::pipeline_instance PipeLineInstance;
    {
        ...
        //
        {
            ...
            {
                e14::DebugMessage(Err.getMessage());
        ...
        //
        {
            ...
            // Load file
            //
            if (auto Err = xbmp::tools::loader::LoadDSS(Bitmap, L"../../Assets/StoneWal01_1K/Stone Wall 01_1K_Specular.dds"); Err)
            {
                e14::DebugMessage(Err.getMessage());
                std::exit(Err.getStateUID());
            }
        ...
        //
        {
            ...
            // Load file
            //
            if (auto Err = xbmp::tools::loader::LoadDSS(Bitmap, L"../../Assets/StoneWal01_1K/Stone Wall 01_1K_Metallic.dds"); Err)
            {
                e14::DebugMessage(Err.getMessage());
                std::exit(Err.getStateUID());
            }
