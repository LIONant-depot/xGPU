...
namespace e15
{
    ...
    {
        xmath::fmat4 m_L2C;
        xmath::fmat4 m_ShadowL2CPlus;
        xmath::fvec4 m_LocalSpaceLightPos;
    };
    ...
    {
        xmath::fmat4 m_L2C;                   // To light space
    };
};
...
int E15_Example()
{
    ...
    xgpu::pipeline_instance ShadowGenerationPipeLineInstance;
    {
        xgpu::shader FragmentShader;
        {
            ...
            { std::array {
                #include "E15_ShadowmapGeneration_frag.h" 
            }};
        ...
        xgpu::shader VertexShader;
        {
            auto RawData = xgpu::shader::setup::raw_data
            { std::array {
                #include "E15_ShadowmapGeneration_vert.h"
            }};
    ...
    xgpu::pipeline PipeLine;
    {
        ...
        xgpu::shader MyVertexShader;
        {
            auto RawData = xgpu::shader::setup::raw_data
            { std::array {
                #include "E15_ShadowmapLighting_vert.h"
            }};
    ...
    xgpu::pipeline_instance PipeLineInstance;
    {
        ...
        //
        {
            ...
            {
                e15::DebugMessage(Err.getMessage());
    ...
    // Create mesh
    //
    auto Mesh = xprim_geom::cube::Generate( 4, 4, 4, 4, xprim_geom::float3{1,1,1} ); xmath::fvec2 UVScale{1,1};
    ...
    while (Instance.ProcessInputEvents())
    {
        ...
        //
        {
            ...
            {
                xmath::fmat4 L2W;
                L2W.setupSRT({ 0.1f * (1 + i),1 * (1 + i * 0.6f),0.1f * (1 + i) }, {0_xdeg}, { 0, 0, i * 2.0f - 8 });
            ...
            {
                xmath::fmat4 L2W;
                L2W.setupSRT({ 100, 0.5f, 100 }, {0_xdeg}, { 0, -1, 0 });
