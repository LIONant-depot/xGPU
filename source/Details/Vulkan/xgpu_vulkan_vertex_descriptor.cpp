    ...
    ) noexcept
    {
        ...
        for (int i = 0; i < Setup.m_Attributes.size(); ++i)
        {
            ...
            auto Format = [](auto Format) constexpr
            {
                ...
                case xgpu::vertex_descriptor::format::UINT8_4D:                     return std::pair{ VK_FORMAT_R8G8B8A8_UINT,              1 * 4 };
                case xgpu::vertex_descriptor::format::SINT8_4D:                     return std::pair{ VK_FORMAT_R8G8B8A8_SINT,              1 * 4 };
                ...
                case xgpu::vertex_descriptor::format::SINT16_1D:                    return std::pair{ VK_FORMAT_R16_SINT,                   2 * 1 };
                ...
                case xgpu::vertex_descriptor::format::SINT16_2D:                    return std::pair{ VK_FORMAT_R16G16_SINT,                2 * 2 };
                case xgpu::vertex_descriptor::format::UINT16_2D:                    return std::pair{ VK_FORMAT_R16G16_UINT,                2 * 2 };
                case xgpu::vertex_descriptor::format::UINT16_3D:                    return std::pair{ VK_FORMAT_R16G16B16_UINT,             2 * 3 };
                case xgpu::vertex_descriptor::format::SINT16_3D:                    return std::pair{ VK_FORMAT_R16G16B16_SINT,             2 * 3 };
                case xgpu::vertex_descriptor::format::UINT16_4D:                    return std::pair{ VK_FORMAT_R16G16B16A16_UINT,          2 * 4 };
                case xgpu::vertex_descriptor::format::SINT16_4D:                    return std::pair{ VK_FORMAT_R16G16B16A16_SINT,          2 * 4 };
                ...
                case xgpu::vertex_descriptor::format::UINT_RGB10A2_4D_NORMALIZED:   return std::pair{ VK_FORMAT_A2B10G10R10_UNORM_PACK32,       4 };
                }
