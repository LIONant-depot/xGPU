...
// "Texture Editor"). Titles use Name###StableId so focus/dock stay stable.
//
// NOTE: Do NOT bump FramePadding to make these tabs taller. Main DockSpace uses
// AutoHideTabBar and nested DockSpaces share the same style path — tall padding
// for the root tab bar desyncs TitleBarHeight/MenuBar and clips nested panel tabs
